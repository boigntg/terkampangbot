...
def gmutestat(bot: Bot, update: Update, args: List[str]):
    if len(args) > 0:
        ...
        update.effective_message.reply_text("Give me a few arguments to choose a setting! on/off, yes/no!\n\n"
...
__help__ = """
*Admin only:*
 - /gmutestat <on/off/yes/no>: Activate Global Silent in your group, or Your current settings will be returned.

Boat owners are also known as Global Mutes to silence spammers in all groups. This will help you and your groups to remove spammers as quickly as possible.
You can disable them for your group by calling / gmutestat ...
