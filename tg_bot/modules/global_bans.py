...
from tg_bot import dispatcher, OWNER_ID, SUDO_USERS, GBAN_LOGS, SUPPORT_USERS, STRICT_GBAN
    ...
    for chat in chats:
        ...
        try:
            ...
            if excp.message in UNGBAN_ERRORS:
                ...
                bot.send_message(GBAN_LOGS, "Could not un-gban due to: {}".format(excp.message))
                return
        except TelegramError:
            pass
